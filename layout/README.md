...
- <div style="display: inline-block; width: 10px; height: 10px; background: #D0021B;">&nbsp;</div> = Container *(modifier: full-bleed)*
- <div style="display: inline-block; width: 10px; height: 10px; background: #F8E71C;"></div> = Container
- <div style="display: inline-block; width: 10px; height: 10px; background: #000;"></div> = Grid
- <div style="display: inline-block; width: 10px; height: 10px; background: #4A90E2;"></div> = Side-by-side
